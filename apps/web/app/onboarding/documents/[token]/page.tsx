...
const CATEGORY_DESCS: Record<string, string> = {
  identity: 'Government-issued ID and proof of address',
  company: 'Official Companies House documents',
  tax: 'HMRC reference numbers and certificates',
  financial: 'Bank statements and financial records',
  access: 'Software and portal access credentials',
};
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {!isRequired && (
                <span className="px-1.5 py-0.5 text-xs font-medium text-gray-400 bg-gray-50 rounded-full border border-gray-100">
                  Optional
                </span>
              )}
              {isUploaded && (
                <span className="px-1.5 py-0.5 text-xs font-medium text-green-700 bg-green-50 rounded-full border border-green-100">
                  ✓ Uploaded
                </span>
              )}
            </div>
          ...
          <button onClick={() => setExpanded(!expanded)}
            className="p-1 text-gray-300 hover:text-gray-500 flex-shrink-0 transition-colors mt-0.5">
            ...
            {summary.isComplete ? (
              <div className="mt-4 flex items-center gap-2 p-3 bg-green-50 border border-green-200 rounded-xl">
                ...
                <p className="text-sm font-semibold text-green-800">
                  All required documents received — click "Submit All" above to complete.
                </p>
              </div>
            ) : (
