...
export const FIRMS: Record<string, FirmConfig> = {
  ...
  llp: {
    ...
    email: 'info@gnsassociates.co.uk',
    website: 'www.gnsassociates.co.uk',
    logo: '/logos/gns.png',   // shared logo until LLP logo provided
    regBody: 'ICAEW',
    regStatement: 'GNS Associates LLP is registered in England & Wales as a Limited Liability Partnership. Regulated by the Institute of Chartered Accountants in England and Wales.',
    gradient: 'from-indigo-700 to-blue-900',
    accentColor: '#1e3a8a',
    description: 'Partnership-focused accounting, tax planning, and business advisory services.',
  },
  galaxy: {
    slug: 'galaxy',
