  ...
  const serviceRows = d.services
    .map(s => `
      <tr>
        ...
        <td style="padding:8px 12px;border-bottom:1px solid #f3f4f6;font-size:13px;text-align:right;color:#6b7280">£${s.monthlyFee.toFixed(2)}</td>
        <td style="padding:8px 12px;border-bottom:1px solid #f3f4f6;font-size:13px;text-align:right;color:#6b7280">£${s.annualFee.toFixed(2)}</td>
      </tr>
    `)
    .join('');
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;margin:0 0 20px">
      ...
      <tbody>
        ...
        <tr style="background:#f9fafb">
          ...
          <td style="padding:10px 12px;text-align:right;font-size:13px;font-weight:600;color:#111">£${d.totalMonthlyFee.toFixed(2)}</td>
          <td style="padding:10px 12px;text-align:right;font-size:13px;font-weight:600;color:#111">£${d.totalAnnualFee.toFixed(2)}</td>
        </tr>
        <tr>
